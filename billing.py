...
#=============TITLE==================
        ...
        lbl_search=Label(ProductFrame2,text="Search Product | By KANKONA",font=("times new roman",15,"bold"),bg="white",fg="green").place(x=2,y=5)
        ...
        lbl_p_price=Label(Add_CartWidgetsFrame,text="Quantity",font=("times new roman",15),bg="white").place(x=390,y=5)
        txt_p_price=Entry(Add_CartWidgetsFrame,textvariable=self.var_qty,font=("times new roman",15),bg="lightyellow",).place(x=390,y=35,width=120,height=22)
...
#=======Billing button=============
        ...
        btn_generate=Button(billMenuFrame,text='Generate Bill/Save Bill',command=self.generate_bill,cursor='hand2',font=("goudy old style",15,"bold"),bg="#009688",fg="white")
        btn_generate.place(x=246,y=80,width=160,height=50)
        
        #=======footer=====
        footer=Label(self.root,text="IMS Inventory Managemenet System | Developed By Kankona\nFor any Technical Issue contact: 9635*****1",font=("times new roman",11),bg="#4d636d",fg="white",bd=0,cursor="hand2").pack(side=BOTTOM,fill=X)
...
#=========all functions===========
     ...
     def bill_updates(self):
             ...
             self.cartTitle.config=Label(text=f"Cart \t Total Product: [{str(len(self.cart_list))}]")
...
{str("="*47)}\n
     ...
     def clear_all(self) :
         ...
         self.txt_bill_area.delete('1.0',END)
         self.cartTitle.config=Label(text=f"Cart \t Total Product: [0]")
         self.var_search.set('')
         self.clear_cart()
         self.show()
         self.show_cart()   
