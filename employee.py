...
class employeeClass:
    def __init__(self,root):
        ...
        txt_contac=Entry(self.root,textvariable=self.var_contact,font=("goudy old style",15),bg="lightyellow").place(x=850,y=150,width=180)
        ...
        cmb_utype.place(x=850,y=230,width=100)
        cmb_utype.current(0)
