...
#===============================
        ...
        #===column2====
        cmb_search=ttk.Combobox(product_Frame,textvariable=self.var_cat,values=self.cat_list,state='readonly',justify=CENTER,font=("goudy old style",15))
        ...
        txt_qty=Entry(product_Frame,textvariable=self.var_qtyt,font=("goudy old style",15),bg='lightyellow').place(x=150,y=260,width=200)
